 ...
 */
function wrappedAmount(currencyAmount: CurrencyAmount, chainId: ChainId = ChainId.POLYGON): TokenAmount {
  if (currencyAmount instanceof TokenAmount) return currencyAmount
  if (currencyAmount.currency === CAVAX[chainId]) return new TokenAmount(WAVAX[chainId], currencyAmount.raw)
  invariant(false, 'CURRENCY')
}

function wrappedCurrency(currency: Currency, chainId: ChainId = ChainId.POLYGON): Token {
...
export class Trade {
  ...
  public readonly chainId: ChainId = ChainId.POLYGON
   ...
   */
  public static exactIn(route: Route, amountIn: CurrencyAmount, chainId: ChainId = ChainId.POLYGON): Trade {
   ...
   */
  public static exactOut(route: Route, amountOut: CurrencyAmount, chainId: ChainId = ChainId.POLYGON): Trade {
    return new Trade(route, amountOut, TradeType.EXACT_OUTPUT, chainId)
  }

  public constructor(route: Route, amount: CurrencyAmount, tradeType: TradeType, chainId: ChainId = ChainId.POLYGON) {
   ...
   */
  public minimumAmountOut(slippageTolerance: Percent, chainId: ChainId = ChainId.POLYGON): CurrencyAmount {
   ...
   * @param slippageTolerance tolerance of unfavorable slippage from the execution price of this trade
   */
  public maximumAmountIn(slippageTolerance: Percent, chainId: ChainId = ChainId.POLYGON): CurrencyAmount {
    invariant(!slippageTolerance.lessThan(ZERO), 'SLIPPAGE_TOLERANCE')
